 ...
 * for the lifetime of a Transfer/Trade flow and computes AGGREGATE features
 ...
 * changes, intervals). This mirrors how real behavioral-biometrics systems
 * transport signal, and it's the only sane volume of data to ship per flow.
 */
...
export default class BehavioralTracker {
  ...
  /** Inter-keystroke interval timing only — never logs the typed content. */
