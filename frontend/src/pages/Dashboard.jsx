        ...
        {loading ? (
          ...
          <>
            <Card className="md:col-span-1">
              ...
              <p className="font-display text-[26px] leading-[32px] font-semibold text-ink-900">
            ...
            <Card className="md:col-span-2">
              ...
              <p className="font-display text-[26px] leading-[32px] font-semibold text-ink-900 mb-3">
