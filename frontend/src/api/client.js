...
/**
 * Reads an SSE stream via fetch (not the native EventSource, which cannot
 * pass Authorization/X-Session-Id/X-Device-Fingerprint headers).
 * Invokes onEvent({ event, data }) for each SSE frame as it arrives.
 */
